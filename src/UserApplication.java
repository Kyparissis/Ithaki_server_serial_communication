...
/**
 * @apiNote This is a SCRIPT that runs the applications needed to "communicate"
 *          receive/generate output requested from the assignment instructions
...
public class UserApplication {
	...
	public static void main(String[] args) {
		...
		// When "CAM=FIX" (Default value) accompanies the image_request_code, the fixxed
		// camera is used
		...
		//
		// When "R=ΧPPPPLL" accompanies the code gps_request_code, Ithaki's server send
		// LL GPS packets from
	...
	/**
	 * Reads the VirtualModem's output and return the full text it returns (Reads
	 * until -1 is returned from the modem (End of stream))
	 * 
	 ...
	 * 
	 * @param DatesTimes An array containing the date and times the application
	 *                   started running
	 */
