...
---
## Output
*After each session, we saved the `output` folder, where the session's output is generated by the code, into the `sessions-output` folder and renamed it in order to store it.*
### Session #1
*(Date: 12/04/2022)*   
